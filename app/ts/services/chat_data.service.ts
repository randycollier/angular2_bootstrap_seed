...
let me: User      = new User('Juliet', '../resources/images/avatars/female-avatar-1.png');
let ladycap: User = new User('Lady Capulet', '../resources/images/avatars/female-avatar-2.png');
let echo: User    = new User('Echo Bot', '../resources/images/avatars/male-avatar-1.png');
let rev: User     = new User('Reverse Bot', '/../resources/images/avatars/female-avatar-4.png');
let wait: User    = new User('Waiting Bot', '../resources/images/avatars/male-avatar-2.png');
